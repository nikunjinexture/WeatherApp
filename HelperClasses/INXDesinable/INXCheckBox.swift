...
class INXCheckBox: UIControl {
    ...
    @IBInspectable var font : UIFont = UIFont(name: "Poppins-Medium", size: 15)!
        {
        didSet
        {
            labelView.font = font
    ...
    override func layoutSubviews() {
        ...
        if isChecked {
            labelView.font = UIFont(name: "Poppins-Bold", size: 15)
        }
        else {
            labelView.font = UIFont(name: "Poppins-Medium", size: 15)
        }
    }
